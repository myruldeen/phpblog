...
public $upload_errors_array = array(
	...
	//method for photo only to find specific photo title
	public static function find_pattern($pattern) {

		return static::find_by_query("SELECT * FROM ". static::$db_table . " WHERE title LIKE '%$pattern%'");
	}
	...
	// 	global $database;
	// 	$the_result_array = static::find_by_query("SELECT * FROM " . static::$db_table . " WHERE cat_id = $id LIMIT 1");
